...
INI.prototype.addValue = function (section,key,value) {
    var se = this.getOrCreateSection(section);
    se[key] = value
    fs.writeFile(fName,this.encodeSection(section,se),function () {
        console.log('修改配置文件')
    })
}


INI.prototype.update = function (section,obj) {
    var se = this.getOrCreateSection(section);
    for(var key in  obj){
        se[key] = obj[key];
    }
